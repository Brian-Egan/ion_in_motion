module Ion
  ...
  class << self
    ...
    def font(size=18)
       ...
       # ""
       # UIFont.fontWithName("ionicons", size: size)
    end
    ...
    # # @return [UIImage]
     def image(icon_name, opts={})
        ...
        icon_name = icon_name.gsub("ion_", "") if icon_name[0..3] == "ion_"
        ...
        # IonIcons.imageWithIcon(icon_name, iconColor: color, iconSize: size, imageSize: opts[:image_size])
